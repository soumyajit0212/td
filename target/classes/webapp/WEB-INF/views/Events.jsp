...
<div class="w3-main" style="margin-left:350px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i>  Add Events           </b><a href="${pageContext.request.contextPath}/events/create"><img src="${pageContext.request.contextPath}/resources/images/add.png" height="30px" width="30px"></a></h5>
  </header>
  ...
  <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
      ...
      <tr class="w3-red"><th>Event Name</th><th>Venue</th><th>Date</th><th>Status</th><th></th></tr>
      <c:forEach items="${events}" var="event"> 
      <tr class="w3-hover-green">
      <td>${event.eventName}</td><td>${event.venueAddress}</td><td>${event.eventDate}</td><td>${event.status}</td>
      <td>
      <a href="${pageContext.request.contextPath}/events/edit/${event.eventId}" class="w3-bar-item w3-button"><i class="fa fa-edit"></i></a>
      <a href="${pageContext.request.contextPath}/events/delete/${event.eventId}" class="w3-bar-item w3-button"><i class="fa fa-trash"></i></a>
      </td>
      </tr>
      </c:forEach>
      </table>
