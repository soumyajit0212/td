...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="${pageContext.request.contextPath}/products/${product.eventId}" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-hand-o-right fa-fw"></i>  ${product.productName}</a>
    </c:forEach>
  </div>
</nav>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-users"></i> Enter Product Details for ${event.eventName } and Click Next to Provide Additional Product Details</b></h5>
  </header>
  ...
  <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
      ...
      <div class="row">
    	...
    	<div class="col-50">
    	<form:input path="productName" cssClass="w3-input w3-border" />
  	 ...
  	 <div class="row">
    	<div class="col-50">
      	<label for="fname">Enter Product Type (It could be Entry, Lunch, Dinner etc.)</label>
    	</div>
    	<div class="col-50">
	...
	<div class="row">
    	<div class="col-50">
      	<label for="fname">Is this Type Mandatory for all family members. (eg; pay for all family members)</label>
    	</div>
    	<div class="col-50">
      	<form:checkbox path="mandatory" cssClass="w3-check" value="YES" checked="checked" />
    	</div>
  	 </div>
  	 
  	 <div class="row">
    	<div class="col-50">
      	<label for="fname">Is this Food provided in Box</label>
    	</div>
    	<div class="col-50">
      	<form:checkbox path="foodBox" cssClass="w3-check" value="YES" checked="checked" />
    	</div>
  	 </div>
  	 
  	<div class="row">
  	<div class="col-50">
  	<button type="submit" class="w3-button w3-red w3-third" value="Save" >NEXT</button>
  	</div>
  	</div> 
